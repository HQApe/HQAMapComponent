#
# Be sure to run `pod lib lint HQMapComponent.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/HQApe/HQMapComponent'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'HQApe' => 'zhanghuaqing8080@163.com' }
  s.source           = { :git => 'https://github.com/HQApe/HQMapComponent.git', :tag => s.version.to_s }
